...
const TradesList: React.FC<TradesListProps> = ({ trades }) => {
  ...
  return (
    <div className="relative w-full h-[450px] bg-light-card/90 dark:bg-dark-card/90 border border-light-border/40 dark:border-dark-border/40 rounded-2xl shadow-2xl transition-shadow hover:shadow-[0_0_48px_12px_rgba(80,255,180,0.35)] flex flex-col">
      {/* Контент поверх */}
      <div className="relative z-10 flex flex-col flex-1">
        <div className="flex items-center px-4 pt-2 pb-1 border-b border-light-border/40 dark:border-dark-border/40 bg-light-bg/80 dark:bg-dark-bg/80 rounded-t-2xl">
